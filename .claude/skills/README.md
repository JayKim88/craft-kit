...
| `spec-drift.md` | Procedure 3 — SPEC drift check | "SPEC updated", "requirements changed" |
| `pre-ship-review.md` | Procedure 4 — Pre-ship review | "리뷰", "final review", "완료 전 점검" |
...
| `doc-gardening.md` | Procedure 7 — Doc-gardening scan | "stale docs", "가든", "문서 점검" |
| `code-review.md` | Procedure 8 — Deep code review | "코드 리뷰해줘", "code review" |
| `security-audit.md` | Procedure 9 — Security audit | "보안 감사", "security audit" |
