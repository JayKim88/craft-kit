...
| # | Item | Layer / Area | Severity | Added | Target phase | Status |
|---|---|---|---|---|---|---|
| TD-001 | _(example) Error responses return raw strings, not typed shapes_ | API | 🟡 | _YYYY-MM-DD_ | Phase D | [ ] |
...
<!-- Move rows here once [x], with the fix commit hash. -->
